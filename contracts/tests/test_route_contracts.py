...
class Test_route_contracts(unittest.TestCase):
    ...
    def test_route_create_contract(self):
        ...
        with app.test_request_context('/?username=johndoe&purpose=casual&polyline=test&startPos_latitude=50.0&startPos_longtitude=60.0&endPos_latitude=70.0&endPos_longtitude=80.0', method='POST'):
            self.assertEqual(
                route_create_contract(request), 
                {
                    'username': 'johndoe',
